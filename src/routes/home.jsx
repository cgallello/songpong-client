			...
			<div className="mainPadding">
				<div className="mainWrapper">
					<div className={generating ? "editor hidden" : "editor"}>
						<h2 className="genPageHeading">Spill your guts ✨</h2>
						...
						<form onSubmit={submitSearch} className="searchBar">
							<input
								...
								maxlength="199"
							/>
							<input type="submit" className="search" value="Generate"></input>
						</form>
					...
					<div className={generating ? "generating" : "generating hidden"}>
						<h2 className="generatingHeader">Generating...</h2>
						<h2 className="generatingHeader">Generating...</h2>
						<h2 className="generatingHeader">Generating...</h2>
						<h2 className="generatingHeader">Generating...</h2>
						<h2 className="generatingHeader">Generating...</h2>
						<h2 className="generatingHeader">Generating...</h2>
						<h2 className="generatingHeader">Generating...</h2>
						<p>Shhh this can actually take a few minutes stop complaining</p>
					</div>
				</div>
			</div>
		</main>
